...
# "job='B'; group='g39'; runs=('z4'); first_snap=0; last_snap=188"               # 0-188  ->  0-188  [1e8] long circ 95-188
# "job='C'; group='g205'; runs=('z4'); first_snap=0; last_snap=188"              # 0-188  ->  0-188  [1e8] long circ 126-188
"job='D'; group='g578'; runs=('z4'); first_snap=0; last_snap=188"              # 0-188  ->  0-188  [1e8] long circ 167-188
# "job='E'; group='g1163'; runs=('z4'); first_snap=8; last_snap=188"             # 0-188  ->  8-188  [1e8]
# "job='F'; group='g5760'; runs=('z8'); first_snap=4; last_snap=188"             # 0-188  ->  4-188  [1e8] long circ 155-188
# "job='G'; group='g10304'; runs=('z8'); first_snap=0; last_snap=188"            # 0-188  ->  0-188  [1e8]
# "job='J'; group='g137030'; runs=('z16'); first_snap=5; last_snap=188"          # 0-188  ->  5-188  [1e8]
# "job='K'; group='g500531'; runs=('z16'); first_snap=13; last_snap=188"          # 0-188  ->  9-188  [1e8] start at 13?
# "job='L'; group='g519761'; runs=('z16'); first_snap=39; last_snap=188"         # 0-188  ->  39-188 [5e7]
# "job='M'; group='g2274036'; runs=('z16'); first_snap=57; last_snap=188"         # 0-189  ->  9-188  [2e7] start at 57?
#
...
# Fiducial:
# "job='F'; group='g5760'; runs=('z4'); first_snap=5; last_snap=188"             # 0-188  ->  5-188  [1e8]
# "job='G'; group='g10304'; runs=('z4'); first_snap=0; last_snap=188"            # 0-188  ->  0-188  [1e8]
# "job='H'; group='g33206'; runs=('z8'); first_snap=4; last_snap=188"            # 0-188  ->  4-188  [1e8]
# "job='H'; group='g33206'; runs=('z4'); first_snap=6; last_snap=189"            # 0-189  ->  6-189  [1e8]
# "job='I'; group='g37591'; runs=('z8'); first_snap=6; last_snap=188"            # 0-188  ->  6-188  [1e8]
# "job='I'; group='g37591'; runs=('z4'); first_snap=11; last_snap=188"           # 0-188  ->  11-188 [1e8]
# "job='J'; group='g137030'; runs=('z8'); first_snap=2; last_snap=188"           # 0-188  ->  2-188  [1e8]
# "job='J'; group='g137030'; runs=('z4'); first_snap=10; last_snap=188"          # 0-188  ->  10-188 [1e8]
