...
# "job='B'; group='g39'; runs=('z4'); first_snap=0; last_snap=188"               # 0-188  ->  0-188  [2e9] long circ 95-188
# "job='C'; group='g205'; runs=('z4'); first_snap=0; last_snap=188"              # 0-188  ->  0-188  [2e9] long circ 126-188
# "job='D'; group='g578'; runs=('z4'); first_snap=0; last_snap=188"              # 0-188  ->  0-188  [2e9] long circ 167-188
# "job='E'; group='g1163'; runs=('z4'); first_snap=0; last_snap=188"             # 0-188  ->  8-188  [2e9]
# "job='F'; group='g5760'; runs=('z8'); first_snap=0; last_snap=188"             # 0-188  ->  4-188  [1e9] long circ 155-188
...
# "job='K'; group='g500531'; runs=('z16'); first_snap=9; last_snap=188"          # 0-188  ->  9-188  [8e8] start at 13?
# "job='L'; group='g519761'; runs=('z16'); first_snap=39; last_snap=188"         # 0-188  ->  39-188 [6e8]
# "job='M'; group='g2274036'; runs=('z16'); first_snap=9; last_snap=188"         # 0-189  ->  9-188  [4e8] start at 57?
#
