...
# field="Lya-cont"; out_pre="${colt_dir}"; out_post="output_tree"; check="images"
# field="Lya"; out_pre="${colt_dir}"; out_post="output_tree"; check="images"
...
# "job='M'; group='g2274036'; runs=('z16'); first_snap=57; last_snap=188"         # 0-189  ->  9-188
#
...
# Fiducial:
# "job='F'; group='g5760'; runs=('z4'); first_snap=6; last_snap=188"             # 0-188  ->  5-188
...
# "job='H'; group='g33206'; runs=('z4'); first_snap=7; last_snap=188"            # 0-189  ->  6-189
# "job='I'; group='g37591'; runs=('z8'); first_snap=6; last_snap=188"            # 0-188  ->  6-188
# "job='I'; group='g37591'; runs=('z4'); first_snap=24; last_snap=188"           # 0-188  ->  11-188
...
# "job='K'; group='g500531'; runs=('z4'); first_snap=22; last_snap=188"          # 0-189  ->  16-189
# "job='L'; group='g519761'; runs=('z8'); first_snap=46; last_snap=188"          # 0-189  ->  46-189
# "job='L'; group='g519761'; runs=('z4'); first_snap=51; last_snap=188"          # 0-189  ->  51-189
# "job='M'; group='g2274036'; runs=('z8'); first_snap=62; last_snap=188"         # 0-189  ->  27-189
# "job='M'; group='g2274036'; runs=('z4'); first_snap=72; last_snap=188"         # 0-189  ->  52-189
# "job='N'; group='g5229300'; runs=('z16'); first_snap=72; last_snap=188"        # 0-189  ->  72-189
# "job='N'; group='g5229300'; runs=('z8'); first_snap=83; last_snap=188"         # 0-189  ->  83-189
# "job='N'; group='g5229300'; runs=('z4'); first_snap=87; last_snap=188"         # 0-189  ->  87-189
)
