...
#
# "job='F'; group='g5760'; runs=('noRlim_z4'); first_snap=5; last_snap=188"      # 0-188  ->  5-188  [8e8]
# "job='F'; group='g5760'; runs=('varEff_z4'); first_snap=5; last_snap=188"      # 0-188  ->  5-188  [8e8]
# "job='H'; group='g33206'; runs=('uvb_z8'); first_snap=4; last_snap=188"        # 0-188  ->  4-188  [4e8]
# "job='H'; group='g33206'; runs=('noExt_z8'); first_snap=4; last_snap=188"      # 0-188  ->  4-188  [4e8]
# "job='H'; group='g33206'; runs=('noRlim_z8'); first_snap=4; last_snap=188"     # 0-188  ->  4-188  [4e8]
# "job='H'; group='g33206'; runs=('varEff_z8'); first_snap=3; last_snap=188"     # 0-188  ->  3-188  [4e8]
# "job='H'; group='g33206'; runs=('noRlim_z4'); first_snap=6; last_snap=189"     # 0-189  ->  6-189  [4e8]
# "job='H'; group='g33206'; runs=('varEff_z4'); first_snap=6; last_snap=189"     # 0-189  ->  6-189  [4e8]
# "job='I'; group='g37591'; runs=('uvb_z8'); first_snap=7; last_snap=188"        # 0-188  ->  7-188  [4e8]
# "job='I'; group='g37591'; runs=('noExt_z8'); first_snap=6; last_snap=188"      # 0-188  ->  6-188  [4e8]
# "job='J'; group='g137030'; runs=('uvb_z8'); first_snap=3; last_snap=188"       # 0-188  ->  3-188  [2e8]
# "job='J'; group='g137030'; runs=('noExt_z8'); first_snap=3; last_snap=188"     # 0-188  ->  3-188  [2e8]
# "job='J'; group='g137030'; runs=('noRlim_z8'); first_snap=2; last_snap=188"    # 0-188  ->  2-188  [2e8]
# "job='J'; group='g137030'; runs=('varEff_z8'); first_snap=3; last_snap=188"    # 0-188  ->  3-188  [2e8]
# "job='J'; group='g137030'; runs=('noRlim_z4'); first_snap=10; last_snap=189"   # 0-189  ->  10-189 [2e8]
# "job='J'; group='g137030'; runs=('varEff_z4'); first_snap=10; last_snap=188"   # 0-188  ->  10-188 [2e8]
# "job='K'; group='g500531'; runs=('uvb_z8'); first_snap=8; last_snap=189"       # 0-189  ->  8-189  [1e8]
# "job='K'; group='g500531'; runs=('noExt_z8'); first_snap=8; last_snap=188"     # 0-188  ->  8-188  [1e8]
# "job='L'; group='g519761'; runs=('uvb_z8'); first_snap=23; last_snap=189"      # 0-189  ->  23-189 [1e8]
# "job='L'; group='g519761'; runs=('noExt_z8'); first_snap=46; last_snap=189"    # 0-189  ->  46-189 [1e8]
# "job='M'; group='g2274036'; runs=('uvb_z8'); first_snap=22; last_snap=182"     # 0-189  ->  22-182 [1e8]
# "job='M'; group='g2274036'; runs=('noExt_z8'); first_snap=28; last_snap=189"   # 0-189  ->  28-189 [1e8]
# "job='N'; group='g5229300'; runs=('uvb_z8'); first_snap=0; last_snap=0"        # 0-189  ->  0-0    [1e8]
# "job='N'; group='g5229300'; runs=('noExt_z8'); first_snap=0; last_snap=0"      # 0-189  ->  0-0    [1e8]
# Fiducial:
...
base_dir=/nfs/mvogelsblab001/Lab/Thesan-Zooms-COLT
