...
# field="offsets"; out_pre="${zoom_dir}"; out_post="postprocessing/${field}"; check="FileOffsets/SnapByType"
# field="distances"; out_pre="${zoom_dir}"; out_post="postprocessing/${field}"; check="Subhalo/R_vir"
# field="mag"; out_pre="${zoom_dir}"; out_post="postprocessing/${field}"; check="Subhalo/MstarVel"
# field="candidates"; out_pre="${zoom_dir}"; out_post="postprocessing/${field}"; check="Subhalo/MinMemberDistStarsHR" # Subhalo/StarFlag
# field="halo"; out_pre="${colt_dir}"; out_post="ics"; check="r_group_light"
# field="colt"; out_pre="${colt_dir}"; out_post="ics"; check="circulator"
# field="halo-ion-eq-RHD"; out_pre="${colt_dir}"; out_post="output"; check="f_esc_gal"
field="halo-ion-eq-RHD"; out_pre="${colt_dir}"; out_post="output"; check="Ndot_esc_group_vir"
#field="halo-M1500-RHD"; out_pre="${colt_dir}"; out_post="output"; check="Ndot_esc_group_vir"
#field="halo-optical"; out_pre="${colt_dir}"; out_post="output"; check="Ndot_esc_group_vir"
#field="halo-Ha-RHD"; out_pre="${colt_dir}"; out_post="output"; check="radial_avg"
